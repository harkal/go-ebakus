...
// Service implements an Ebakus netstats reporting daemon that pushes local
// chain statistics up to a monitoring server.
type Service struct {
	server *p2p.Server        // Peer-to-peer server to retrieve networking infos
	eth    *eth.Ebakus      // Full Ebakus service if monitoring a full node
	les    *les.LightEbakus // Light Ebakus service if monitoring a light node
...
func New(url string, ethServ *eth.Ebakus, lesServ *les.LightEbakus) (*Service, error) {
