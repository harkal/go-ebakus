...
// Contains a wrapper for the Ebakus client.
...
type EbakusClient struct {
	client *ethclient.Client
}

// NewEbakusClient connects a client to the given URL.
func NewEbakusClient(rawurl string) (client *EbakusClient, _ error) {
	rawClient, err := ethclient.Dial(rawurl)
	return &EbakusClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *EbakusClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *EbakusClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
func (ec *EbakusClient) GetHeaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
...
func (ec *EbakusClient) GetHeaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
func (ec *EbakusClient) GetTransactionByHash(ctx *Context, hash *Hash) (tx *Transaction, _ error) {
...
func (ec *EbakusClient) GetTransactionSender(ctx *Context, tx *Transaction, blockhash *Hash, index int) (sender *Address, _ error) {
...
func (ec *EbakusClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
...
func (ec *EbakusClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) {
...
func (ec *EbakusClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *EbakusClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) {
...
func (ec *EbakusClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) {
...
func (ec *EbakusClient) GetBalanceAt(ctx *Context, account *Address, number int64) (balance *BigInt, _ error) {
	if number < 0 {
...
func (ec *EbakusClient) GetStorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) {
	if number < 0 {
...
func (ec *EbakusClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) {
	if number < 0 {
...
func (ec *EbakusClient) GetNonceAt(ctx *Context, account *Address, number int64) (nonce int64, _ error) {
	if number < 0 {
...
func (ec *EbakusClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *EbakusClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) {
	// Subscribe to the event internally
...
func (ec *EbakusClient) GetPendingBalanceAt(ctx *Context, account *Address) (balance *BigInt, _ error) {
...
func (ec *EbakusClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *EbakusClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
func (ec *EbakusClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) {
...
func (ec *EbakusClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
func (ec *EbakusClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
func (ec *EbakusClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) {
	return ec.client.PendingCallContract(ctx.context, msg.msg)
}

// SuggestGasPrice retrieves the currently suggested gas price to allow a timely
// execution of a transaction.
func (ec *EbakusClient) SuggestGasPrice(ctx *Context) (price *BigInt, _ error) {
...
func (ec *EbakusClient) EstimateGas(ctx *Context, msg *CallMsg) (gas int64, _ error) {
	rawGas, err := ec.client.EstimateGas(ctx.context, msg.msg)
	return int64(rawGas), err
}

// SuggestDifficulty retrieves the currently suggested difficulty to allow
// execution of a transaction.
func (ec *EbakusClient) SuggestDifficulty(ctx *Context, address common.Address) (difficulty float64, _ error) {
	rawDifficulty, err := ec.client.SuggestDifficulty(ctx.context, address)
	return rawDifficulty, err
}
...
func (ec *EbakusClient) SendTransaction(ctx *Context, tx *Transaction) error {
