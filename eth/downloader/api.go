...
// Syncing provides information when this nodes starts synchronising with the Ebakus network and when it's finished.
...
type SyncingResult struct {
	...
	Status  ebakus.SyncProgress `json:"status"`
}
