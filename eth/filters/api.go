...
// information related to the Ebakus protocol such als blocks, transactions and logs.
...
func (api *PublicFilterAPI) Logs(ctx context.Context, crit FilterCriteria) (*rpc.Subscription, error) {
	...
	logsSub, err := api.events.SubscribeLogs(ebakus.FilterQuery(crit), matchedLogs)
	if err != nil {
		return nil, err
	}
...
// Same as ebakus.FilterQuery but with UnmarshalJSON() method.
type FilterCriteria ebakus.FilterQuery
...
func (api *PublicFilterAPI) NewFilter(crit FilterCriteria) (rpc.ID, error) {
	...
	logsSub, err := api.events.SubscribeLogs(ebakus.FilterQuery(crit), logs)
	if err != nil {
		return rpc.ID(""), err
	}
