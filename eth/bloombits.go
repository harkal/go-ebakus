...
const (
	// bloomServiceThreads is the number of goroutines used globally by an Ebakus
...
func (eth *Ebakus) startBloomHandlers(sectionSize uint64) {
...
// for the Ebakus header bloom filters, permitting blazing fast filtering.
