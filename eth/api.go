...
// PublicEbakusAPI provides an API to access Ebakus full node-related
// information.
type PublicEbakusAPI struct {
	e *Ebakus
}

// NewPublicEbakusAPI creates a new Ebakus protocol API for full nodes.
func NewPublicEbakusAPI(e *Ebakus) *PublicEbakusAPI {
	return &PublicEbakusAPI{e}
}

// Etherbase is the address that mining rewards will be send to
func (api *PublicEbakusAPI) Etherbase() (common.Address, error) {
	return api.e.Etherbase()
}

// Coinbase is the address that mining rewards will be send to (alias for Etherbase)
func (api *PublicEbakusAPI) Coinbase() (common.Address, error) {
	return api.Etherbase()
}

// Hashrate returns the POW hashrate
func (api *PublicEbakusAPI) Hashrate() hexutil.Uint64 {
	return hexutil.Uint64(api.e.Miner().HashRate())
}

// ChainId is the EIP-155 replay-protection chain id for the current ebakus chain config.
func (api *PublicEbakusAPI) ChainId() hexutil.Uint64 {
	chainID := new(big.Int)
...
func NewPublicMinerAPI(e *Ebakus) *PublicMinerAPI {
...
func NewPrivateMinerAPI(e *Ebakus) *PrivateMinerAPI {
...
func (api *PrivateMinerAPI) SetGasPrice(gasPrice float64) bool {
	api.e.lock.Lock()
...
// PrivateAdminAPI is the collection of Ebakus full node-related APIs
...
// admin methods of the Ebakus service.
func NewPrivateAdminAPI(eth *Ebakus) *PrivateAdminAPI {
...
// PublicDebugAPI is the collection of Ebakus full node APIs exposed
...
// related public debug methods of the Ebakus service.
func NewPublicDebugAPI(eth *Ebakus) *PublicDebugAPI {
...
// PrivateDebugAPI is the collection of Ebakus full node APIs exposed over
...
// private debug methods of the Ebakus service.
func NewPrivateDebugAPI(eth *Ebakus) *PrivateDebugAPI {
