...
// all blocks' seal as valid, though they still have to conform to the Ebakus
// consensus rules.
...
// still have to conform to the Ebakus consensus rules.
...
// they still have to conform to the Ebakus consensus rules.
