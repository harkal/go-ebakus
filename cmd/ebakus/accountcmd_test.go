...
func TestAccountListEmpty(t *testing.T) {
	ebakus := runEbakus(t, "account", "list")
	ebakus.ExpectExit()
}

func TestAccountList(t *testing.T) {
	datadir := tmpDatadirWithKeystore(t)
	ebakus := runEbakus(t, "account", "list", "--datadir", datadir)
	defer ebakus.ExpectExit()
...
func TestAccountNew(t *testing.T) {
	ebakus := runEbakus(t, "account", "new", "--lightkdf")
	defer ebakus.ExpectExit()
	ebakus.Expect(`
...
func TestAccountUpdate(t *testing.T) {
	datadir := tmpDatadirWithKeystore(t)
	ebakus := runEbakus(t, "account", "update",
...
func TestWalletImport(t *testing.T) {
	ebakus := runEbakus(t, "wallet", "import", "--lightkdf", "testdata/guswallet.json")
	defer ebakus.ExpectExit()
	ebakus.Expect(`
!! Unsupported terminal, password will be echoed.
...
`)
	...
	files, err := ioutil.ReadDir(filepath.Join(ebakus.Datadir, "keystore"))
	if len(files) != 1 {
...
`)
	...
	for _, m := range wantMessages {
		if !strings.Contains(ebakus.StderrText(), m) {
...
// https://github.com/ebakus/go-ebakus/issues/1785
...
func TestUnlockFlagAmbiguous(t *testing.T) {
	...
	ebakus.SetTemplateFunc("keypath", func(file string) string {
