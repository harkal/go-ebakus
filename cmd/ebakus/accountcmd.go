...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage Ebakus presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    ebakus wallet import /path/to/my/presale.wallet
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Ebakus presale wallet",
				ArgsUsage: "<keyFile>",
				...
				Description: `
	ebakus wallet [options] /path/to/my/presale.wallet
...
between ebakus nodes by simply copying.
...
For non-interactive use the password can be specified with the --password flag:
    ...
    ebakus account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    ebakus account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another ebakus instance,
...
func accountCreate(ctx *cli.Context) error {
	cfg := ebakusConfig{Node: defaultNodeConfig()}
	// Load config file.
