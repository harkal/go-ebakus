...
import (
	...
	"github.com/ebakus/go-ebakus/internal/cmdtest"
	"github.com/ebakus/go-ebakus/rpc"
)

func tmpdir(t *testing.T) string {
	dir, err := ioutil.TempDir("", "ebakus-test")
	if err != nil {
		t.Fatal(err)
	}
	return dir
...
func init() {
	// Run the app if we've been exec'd as "ebakus-test" in runEbakus.
	reexec.Register("ebakus-test", func() {
...
// spawns ebakus with the given command line args. If the args don't set --datadir, the
// child g gets a temporary data directory.
func runEbakus(t *testing.T, args ...string) *testebakus {
	tt := &testebakus{}
	...
	// Boot "ebakus". This actually runs the test binary but the TestMain
	// function will prevent any tests from running.
	tt.Run("ebakus-test", args...)
