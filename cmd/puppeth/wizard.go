...
type wizard struct {
	...
	services map[string][]string   // Ebakus services known to be running on servers
...
// converts it to an Ebakus address. If an empty line is entered, the default
// value is returned.
