...
// setting up a new or managing an existing Ebakus private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Ebakus private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Ebakus network down to  |")
	...
	log.Info("Administering Ebakus network", "name", w.network)
