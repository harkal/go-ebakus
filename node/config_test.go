...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "ebakus.ipc", false, filepath.Join(os.TempDir(), "ebakus.ipc")},
		{"data", "ebakus.ipc", false, "data/ebakus.ipc"},
		{"data", "./ebakus.ipc", false, "./ebakus.ipc"},
		{"data", "/ebakus.ipc", false, "/ebakus.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "ebakus.ipc", true, `\\.\pipe\ebakus.ipc`},
		{"data", "ebakus.ipc", true, `\\.\pipe\ebakus.ipc`},
		{"data", `\\.\pipe\ebakus.ipc`, true, `\\.\pipe\ebakus.ipc`},
	}
