...
var (
	...
	skipPrefixes = []string{
		...
		"crypto/secp256k1", // Relicensed to BSD-3 via https://github.com/ebakus/go-ebakus/pull/17225
	}
	...
	authorsFileHeader = "# This is the official list of go-ebakus authors for copyright purposes.\n\n"
)
