...
# 1. install ebakus for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for ebakus
# 5. create ebakus, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable EBAKUS_SOCKET
...
!define GROUPNAME "Ebakus"
!define APPNAME "Ebakus"
!define DESCRIPTION "Official Go implementation of the Ebakus protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since ebakus is installed global
