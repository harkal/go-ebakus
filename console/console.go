...
type Config struct {
	...
	Client   *rpc.Client  // RPC client to execute Ebakus requests through
...
// Welcome show summary of current Ebakus instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the Ebakus JavaScript console!\n\n"

	// Print some generic Ebakus metadata
