...
// database.
func (t *table) AppendAncient(number uint64, hash, header, body, receipts, ebakusSnapshot []byte) error {
	return t.db.AppendAncient(number, hash, header, body, receipts, ebakusSnapshot)
}
