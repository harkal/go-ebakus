...
func TestLegacyReceiptDecoding(t *testing.T) {
	...
	tx := NewTransaction(1, common.HexToAddress("0x1"), big.NewInt(1), 1, nil)
	receipt := &Receipt{
...
func TestDeriveFields(t *testing.T) {
	...
	txs := Transactions{
		NewContractCreation(1, big.NewInt(1), 1, nil),
		NewTransaction(2, common.HexToAddress("0x2"), big.NewInt(2), 2, nil),
	}
