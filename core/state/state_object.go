...
// stateObject represents an Ebakus account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of ebakus address of the account
	data     Account
	db       *StateDB
...
// Account is the Ebakus consensus representation of accounts.
