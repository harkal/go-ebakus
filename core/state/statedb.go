...
// Package state provides a caching layer atop the Ebakus state trie.
package state
...
// StateDBs within the ebakus protocol are used to store anything
...
func (self *StateDB) Copy() *StateDB {
	...
	for addr := range self.journal.dirties {
		// As documented [here](https://github.com/ebakus/go-ebakus/pull/16485#issuecomment-380438527),
