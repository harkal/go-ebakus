...
// Copyright 2017 The ebakus/go-ebakus Authors
...
class Footer extends Component<Props, State> {
  shouldComponentUpdate(
    ...
    return (
      typeof nextProps.shouldUpdate.general !== 'undefined' ||
      typeof nextProps.shouldUpdate.system !== 'undefined'
    );
  }
    ...
    return (
      <div style={styles.doubleChartWrapper}>
        {this.halfHeightChart(
          {
            syncId,
            data: topChart.data.map(({ value }) => ({
              [topKey]: value || topDefault,
            })),
        ...
        {this.halfHeightChart(
          {
            syncId,
            data: bottomChart.data.map(({ value }) => ({
              [bottomKey]: -value || -bottomDefault,
            })),
      ...
      >
          ...
          <ChartRow>
            {this.doubleChart(
              ...
              CPU,
              {
                ...
                tooltip: percentPlotter(cpuLabelTop),
                label: cpuLabelTop,
              },
              {
                data: system.systemCPU,
                tooltip: percentPlotter(cpuLabelBottom, multiplier(-1)),
            ...
            {this.doubleChart(
              ...
              MEMORY,
              {
                ...
                tooltip: bytePlotter(memoryLabelTop),
                label: memoryLabelTop,
              },
              {
                data: system.virtualMemory,
                tooltip: bytePlotter(memoryLabelBottom, multiplier(-1)),
            ...
            {this.doubleChart(
              ...
              DISK,
              {
                ...
                tooltip: bytePerSecPlotter(diskLabelTop),
                label: diskLabelTop,
              },
              {
                data: system.diskWrite,
                tooltip: bytePerSecPlotter(diskLabelBottom, multiplier(-1)),
            ...
            {this.doubleChart(
              ...
              TRAFFIC,
              {
                ...
                tooltip: bytePerSecPlotter(trafficLabelTop),
                label: trafficLabelTop,
              },
              {
                data: system.networkEgress,
                tooltip: bytePerSecPlotter(trafficLabelBottom, multiplier(-1)),
        ...
        <Grid item>
          <Typography type="caption" color="inherit">
            <span style={commonStyles.light}>Ebakus</span> {general.version}
          </Typography>
          {general.commit && (
            <Typography type="caption" color="inherit">
